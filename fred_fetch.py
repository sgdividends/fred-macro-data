...
SERIES = {
    ...
    "BAMLH0A3HYC":  ("ccc_oas", "ICE BofA CCC & Lower High Yield OAS"),
    "BAMLH0A1HYBB": ("bb_oas", "ICE BofA BB High Yield OAS"),
    "IC4WSA":       ("initial_claims_4wk", "Initial Claims 4-Week Moving Average"),
    "ICSA":         ("initial_claims", "Initial Claims"),
